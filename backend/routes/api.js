...
//to save doctor details into a separate doctor collection
router.post('/saveDoctorDetails', doctorController.saveData);
...
// to create new consultation request
router.post('/new-request', requestController.newRequest);
router.get('/user/:userId/requests', requestController.getAllRequestsByUser);
router.get('/user/:userId/requestsTo', requestController.getAllRequestsByUserTo);
router.post('/updateRequest', requestController.updateRequest);

//get nearby doctors for offline consultation
router.post('/getNearbyDoctors', doctorController.getNearbyDoctors);
router.get('/getOnlineDoctors', doctorController.getOnlineDoctors);
// Upvote a post
router.put(
    '/post/:id/upvote',
    postController.verifyToken,
